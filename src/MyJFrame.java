...
public class MyJFrame extends JFrame implements ActionListener{
 ...
 /* public static void main(String[] args) throws Exception {
  ...
  public void initFrame() throws AWTException, RemoteException{
	  fenetre = new JFrame();
	  robot = new MyRobot();
	  jpanel1 = new JPanel();
  ...
  private class Handlerclass extends UnicastRemoteObject implements MouseListener, MouseMotionListener, JFrameInterface {
	  //MouseListener Event
	  
		protected Handlerclass() throws RemoteException{
			super();
		}
	  
		public Point getClick(int x, int y)
		{
